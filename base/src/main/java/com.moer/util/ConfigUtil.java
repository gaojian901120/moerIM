...
public class ConfigUtil {
    private static  NettyConfig nettyConfig = null;
    public static RedisConfig loadRedisConfig() {
        ...
        redisConfig.setSessionHost(resourceBundle.getString("redis.sessionHost"));
        redisConfig.setSessionPort(Integer.parseInt(resourceBundle.getString("redis.sessionPort")));
        return redisConfig;
    }
    ...
    public static ImConfig loadImConfig() {
        ...
        imConfig.setTrace(Boolean.valueOf(resourceBundle.getString("im.trace")));
        return imConfig;
    }
}
